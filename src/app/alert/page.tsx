...
function AlertInfo() {
    ...
    const time = useMemo(() => {
        ...
        return {start: startTime.substring(0, 5), end: endTime.substring(0, 5), endTimeSuffix };
    }, [alert]);
    ...
    return (
        <main
            className="bg-background flex h-full min-h-screen flex-col items-center justify-center rounded-md p-24 backdrop-blur-md gap-3"
        >
